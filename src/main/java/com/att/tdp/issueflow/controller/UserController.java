 ...
 * It allows administrators to create, update, delete, and query user profiles,
 * as well as fetch user mentions.
 */
public class UserController {
    ...
    // Retrieves a paginated list of comments where the specified user was
    // mentioned.
